  ...
  -- Lesson 7: The Yank Register ("0p, "_d) [advanced]
  {
    ...
    challenges = {
      ...
      h.editing({
        ...
        optimal = 10,
        time = 12.0,
        hint = 'yiw yanks "compute" (no parens); "_dd deletes the debug line; "0p at line end pastes the yank',
      }),
      ...
      h.editing({
        ...
        optimal = 12,
        time = 15.0,
        hint = 'ya" on "hello" (includes quotes); "_dd the scratch line; $ to end of line 2; "0p pastes',
      }),
    },
  },
  ...
  -- Lesson 8: Named Registers ("a, "A, "ap) [advanced]
  {
    ...
    challenges = {
      ...
      h.editing({
        ...
        optimal = 7,
        time = 8.0,
        hint = '"ayy yanks the line into register a; "ap pastes it below (7 keys total)',
      }),
