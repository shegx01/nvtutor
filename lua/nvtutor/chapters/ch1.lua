...
M.lessons = {
  ...
  -- Lesson 7: Page Navigation (Ctrl-f, Ctrl-b, Ctrl-d, Ctrl-u) [advanced]
  {
    ...
    advanced = true,
    challenges = {
      -- Challenge 1: Ctrl-f to reach the end of a long buffer
      h.movement({
        command = '<C-f>',
        instruction = 'Reach line 50 using Ctrl-f (press it until you get there).',
        lines = (function()
          local l = {}
          for i = 1, 50 do l[i] = string.format('Line %2d: content here.', i) end
          return l
        end)(),
        from = { 1, 0 },
        to   = { 50, 0 },
        optimal = 1,
        time = 10.0,
        hint = 'Ctrl-f scrolls a full page forward. Keep pressing until you reach the last line.',
        optimal_solution = 'Ctrl-f repeatedly, or just G to jump to the end',
      }),
      -- Challenge 2: Ctrl-b to get back to the top
      h.movement({
        command = '<C-b>',
        instruction = 'Get back to line 1 using Ctrl-b (press it until you get there).',
        lines = (function()
          local l = {}
          for i = 1, 50 do l[i] = string.format('Line %2d: content here.', i) end
          return l
        ...
        optimal = 1,
        time = 10.0,
        hint = 'Ctrl-b scrolls a full page backward. Keep pressing until you reach line 1.',
        optimal_solution = 'Ctrl-b repeatedly, or just gg to jump to the top',
      }),
      -- Challenge 3: Ctrl-d to reach the end of a long buffer
      h.movement({
        command = '<C-d>',
        instruction = 'Reach line 50 using Ctrl-d (press it until you get there).',
        lines = (function()
          local l = {}
          for i = 1, 50 do l[i] = string.format('Line %2d: content here.', i) end
          return l
        ...
        optimal = 1,
        time = 10.0,
        hint = 'Ctrl-d scrolls half a page down. Keep pressing until you reach the last line.',
        optimal_solution = 'Ctrl-d repeatedly — half-page jumps are great for scanning code',
      }),
    },
  },
}
